...
@section('backend_content')
    <div
        class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 border-bottom  bg-warning">
        <h1 class="h2 text-center">Dashboard</h1>
    </div>

    <canvas class="my-4 w-100" id="myChart" height="1"></canvas>
    <h4 class="text-center">User Details</h4>
    <div class="table-responsive fs-6 card-body">
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    <td>{{ 'STD' . $student->session . $student->id }}</td>
                    <td>{{ $student->name }}</td>
                    <td>{{ $student->course_name . '(session ' . $student->session . '-' . (int) $student->session + 1 . ')' }}</td>
                    <td>{{ $student->email }}</td>
    ...
    <script>
        $(document).ready(function() {
            $('.image-form').on('submit', function(e) {
                ...
                function validateImage(file, expectedWidth, expectedHeight, errorElement) {
                ...
                // Validate image and signature dimensions
                var imageValidation = image ? validateImage(image, 300, 300, '#image-error') : Promise
                    .resolve();
                var signatureValidation = signature ? validateImage(signature, 300, 80,
