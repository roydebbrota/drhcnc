                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="father_phone" type="text"
                                        ...
                                        name="father_phone" value="{{ old('father_phone') }}" required autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="nid_birth_reg_num" type="text"
                                        ...
                                        name="nid_birth_reg_num" value="{{ old('nid_birth_reg_num') }}" required
                                        autofocus>
                            ...
                            <div class="row mb-3 border">
                                ...
                                <div class="col-md-4 mb-2">
                                    <label for="post_office"
                                        class=" col-form-label text-md-end">{{ __('Post Office') }}<span
                                            class= "text-danger">*</span></label>
                            ...
                            <div class="row mb-3 border">
                                ...
                                <div class="col-md-2 mb-2">
                                    <label for="ssc_year"
                                        class=" col-form-label text-md-end">{{ __('Passing Year') }}<span
                                            class= "text-danger">*</span></label>
                            ...
                            <div class="row mb-3 border">
                                ...
                                <div class="col-md-2 mb-2">
                                    <label for="govt_score"
                                        class=" col-form-label text-md-end">{{ __('Test Score') }}<span
                                            class= "text-danger">*</span></label>
                                ...
                                <div class="col-md-2 mb-2">
                                    <label for="govt_serial"
                                        class=" col-form-label text-md-end">{{ __('Serial No.') }}<span
                                            class= "text-danger">*</span></label>
                                    <input id="govt_serial" type="number" step="1"
                                        class="form-control @error('govt_serial') is-invalid @enderror"
                                        name="govt_serial" value="{{ old('govt_serial') }}" required>
                                ...
                                <div class="col-md-2 mb-2">
                                    <label for="govt_user_id"
                                        class=" col-form-label text-md-end">{{ __('User ID') }}<span
                                            class= "text-danger">*</span></label>
                                    <input id="govt_user_id" type="text"
                                        class="form-control @error('govt_user_id') is-invalid @enderror"
                                        name="govt_user_id" value="{{ old('govt_user_id') }}" required>
                                ...
                                <div class="col-md-2 mb-2">
                                    <label for="govt_password"
                                        class=" col-form-label text-md-end">{{ __('Password') }}<span
                                            class= "text-danger">*</span></label>
                            ...
                            <div class="row mb-3">
                                <label for="religion"
                                    class="col-md-3 col-form-label text-md-end">{{ __('Religion') }}<span
                                        class= "text-danger">*</span></label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="file" class="@error('image') is-invalid @enderror image"
                                        id="image" name="image" value="{{ old('image') }}" />
                                    <div id="image-error" class="alert alert-danger" style="display: none;"></div>
                                    @error('image')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    <small class="w-100 text-danger">Photo must be 300 x 300 pixel (width x height)[.jpg format] and file size not more than 100 KB(min.4KB)</small>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="signature"
                                ...
                                <div class="col-md-8">
                                    ...
                                    @error('signature')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    <small class="w-100 text-danger">Signature must be 300 x 80 pixel (width x height)[.jpg format] and file size not more than 60 KB(min.4KB)</small>
                                </div>
                            </div>
                            <div class="row mb-0">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('form').on('submit', function(e) {
                ...
                if (image) {
                    ...
                    img.onload = function() {
                        if (this.width === 300 || this.height === 300) {
                            $('#image-error').text('Image dimensions should be 300x300').show();
                            valid = false;
                        }
                ...
                if (signature) {
                    var sig = new Image();
                    sig.src = URL.createObjectURL(signature);
                    sig.onload = function() {
                        ...
                        $('#signature-error').text('Signature dimensions should be 150x300').show();
                        valid = false;
                        // Re-submit the form if valid
                    };
                }

                // Ensure both validations have finished
                if ((image && img.complete === false) || (signature && sig.complete === false)) {
                    // Temporarily prevent the form submission to wait for the image onload events to finish
                    e.preventDefault();

                    // Re-check after a small delay to allow image onload events to complete
                    setTimeout(function() {
                        if (!valid) e.preventDefault();
                        else $('form').off('submit').submit(); // Re-submit the form if valid
                    }, 100);
                }
            });
        });
