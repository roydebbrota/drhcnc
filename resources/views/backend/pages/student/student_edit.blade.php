                    ...
                    <form method="POST" action="{{ route('student.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text"
                                    ...
                                    value="{{ old('name', $studentId->name) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="name_bangla" type="text"
                                    ...
                                    value="{{ old('name_bangla', $studentId->name_bangla) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="father" type="text"
                                    ...
                                    value="{{ old('father', $studentId->father) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="mother" type="text"
                                    ...
                                    value="{{ old('mother', $studentId->mother) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="phone" type="text"
                                    ...
                                    value="{{ old('phone', $studentId->phone) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="father_phone" type="text"
                                    ...
                                    value="{{ old('father_phone', $studentId->father_phone) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="blood_group" type="text"
                                    ...
                                    value="{{ old('blood_group', $studentId->blood_group) }}" required>
                        ...
                        @if (Auth::user()->role === 'SuperAdmin')
                            <div class="row mb-3">
                                ...
                                @if ($studentId->image)
                                    <div class="col-md-3">
                                        <img src="{{ asset($studentId->image) }}" style="width:150px; height:auto"
                                            alt="d-flex">
                                    </div>
                                @endif
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input type="file" class="@error('signature') is-invalid @enderror signature"
                                ...
                                @if ($studentId->signature)
                                    <div class="col-md-3">
                                        <img src="{{ asset($studentId->signature) }}" style="width:150px; height:auto"
                                            alt="d-flex">
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="row mb-3">
                            <label for="contract_amount"
                                class="col-md-3 col-form-label text-md-end">{{ __('Contract Amount') }}</label>

                            <div class="col-md-8">
                                <input id="contract_amount" type="number"
                                    class="form-control @error('contract_amount') is-invalid @enderror"
                                    name="contract_amount"
                                    value="{{ $studentId['contract_amount'] ?? old('contract_amount') }}">
                        ...
                        <div class="row mb-3">
                            <label for="note"
                                class="col-md-3 col-form-label text-md-end">{{ __('Note') }}</label>

                            <div class="col-md-8">
                                <textarea type="note" class="form-control summernote" name="note" id="note"
                                    @error('note') is-invalid @enderror>{{ $studentId['note'] }}</textarea>
